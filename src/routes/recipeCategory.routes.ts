...
router.get("/", validateQuery(listRecipeCategoryQuerySchema), recipeCategoryController.list);
router.get("/:id", validateParams(idParamSchema), recipeCategoryController.getById);
router.post("/", authenticate, validate(createRecipeCategorySchema), recipeCategoryController.create);
router.put(
  "/:id",
  authenticate,
...
router.delete("/:id", authenticate, validateParams(idParamSchema), recipeCategoryController.remove);
