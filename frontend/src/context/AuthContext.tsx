...
import { fetchWithAuth, setTokens, clearTokens, getAccessToken } from '../services/api';
...
interface AuthContextType {
  ...
  handleRegister: (email: string, password: string, firstName: string, lastName?: string) => Promise<boolean>;
